    ...
    <Card className="max-w-2xl mx-auto bg-gradient-to-br from-ivory via-soft-pink/40 to-champagne/30 border-2 border-rose-gold/40 shadow-[var(--shadow-glow)] overflow-hidden">
      ...
      <div className="relative bg-gradient-to-r from-rose-gold to-accent p-8 text-center">
        ...
        <div className="relative z-10">
          <Heart className="w-12 h-12 text-white fill-white mx-auto mb-3 animate-pulse" />
          <h1 className="text-3xl font-playfair text-white font-bold">
            You're Invited!
          </h1>
        </div>
      </div>
      ...
      <div className="p-8 sm:p-12 space-y-6">
        ...
        <div className="text-center border-b-2 border-rose-gold/20 pb-6">
          ...
          <h2 className="text-3xl font-playfair text-rose-gold font-bold">
            {guestName}
          </h2>
        </div>
        ...
        <div className="text-center py-6">
          <p className="text-lg font-poppins text-muted-foreground mb-4">
            Together with their families
          </p>
          <h3 className="text-4xl sm:text-5xl font-playfair text-foreground font-bold mb-2">
            Saheba
          </h3>
          ...
          <h3 className="text-4xl sm:text-5xl font-playfair text-foreground font-bold">
            Sufiyan
          </h3>
          <p className="text-lg font-poppins text-muted-foreground mt-4">
        ...
        <div className="space-y-4 bg-card/60 backdrop-blur-sm rounded-2xl p-6 border border-rose-gold/20">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="font-playfair text-xl text-foreground font-semibold">
                December 26, 2025
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="font-poppins text-sm text-muted-foreground">Venue</p>
